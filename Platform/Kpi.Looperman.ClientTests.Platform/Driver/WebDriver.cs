...
using Kpi.Looperman.ClientTests.Platform.Enum;
using OpenQA.Selenium;
using OpenQA.Selenium.Chrome;
using OpenQA.Selenium.Remote;
using Serilog;
using IJavaScriptExecutor = Kpi.Looperman.ClientTests.Model.Platform.Drivers.IJavaScriptExecutor;

namespace Kpi.Looperman.ClientTests.Platform.Driver
{
